...
IEnumerable<DateTime> ocurrences = schedule.GetNextOccurrences(start, end);

foreach(DateTime ocurrence in ocurrences.Take(40))
{
    WriteLine($"Ocurrence at: {ocurrence:ddd, dd MMM yyyy HH:mm:ss}");
}    