...
public class FluentExample
{
    ...
    public void TestCollection()
    {
        ...
        names.Should().HaveCountLessThan(4,
            "because the maximun items should be 3 or fewer");
    ...
    {
        DateTime when = new(hour: 9, minute: 30, second: 0, day: 25, month: 3, year: 2022);
        ...
        DateTime due = new(hour: 13, minute: 0, second: 0, day: 25, month: 3, year: 2022);
